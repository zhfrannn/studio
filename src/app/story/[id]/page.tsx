...
function StoryDetailClient({ storyId }: { storyId: string }) {
  ...
  if (!story) {
    // This will show a not found page, but it will be handled by the server component's notFound() initially
    return null;
  }

  const content: InteractiveContent | undefined =
    getInteractiveContent(dictionary)[story.id];
...
export default function StoryDetailPage({ params }: { params: { id: string } }) {
  ...
  // We pass the ID to the client component, which will then get the story from the context.
